...
/**Latest version. This is the icon menu bar (the bar under the menu bar that contains all the icons. Overrided to remove unused icons. */
public class MyEditorToolBar extends JToolBar {
	 ...
	 * 
	 */
	public MyEditorToolBar(final MyBasicGraphEditor2 editor, int orientation, DTE9 dte) {
		super(orientation);
		...
		add(editor.bind("Delete", new DeleteSelectedEdgesAction(), "/com/mxgraph/examples/swing/images/delete.gif"));
